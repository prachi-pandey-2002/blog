						   ...
						   <table id="datatable" class="table table-striped table-bordered" style="width:100%">
							  ...
							  @foreach($result as $list)
								 <tr>
									...
									<td>
									<a class="btn btn-info color_white" style="color:white;" href="{{url('admin/post/edit/'.$list->id)}}">Edit</a>
									<a class="btn btn-danger color_white" style="color:white;" href="{{url('admin/post/delete/'.$list->id)}}">Delete</a>
									</td>
								 </tr>
								 @endforeach
							  </tbody>
