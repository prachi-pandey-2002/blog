...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="{{url('/')}}">{{ Config::get('constants.site_name') }}</a>
        ...
        <!-- Page Header-"background-image:url('{{ asset('front_asset/assets/img/home-bg.jpg')}}')"-->
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        <div class="site-heading">
                           ...
                           <span class="subheading">Blog : A directory of wonderful things</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        ...
                        <p class="copyright text-muted">Copyright &copy; My Blog Website 2021</p>
                    </div>
                </div>
            </div>
        </footer>
